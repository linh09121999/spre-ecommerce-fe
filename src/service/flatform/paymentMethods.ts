...
export const CreateAPaymentMethod = (data: { payment_method: PaymentMethod }, include?: string): Promise<AxiosResponse> => {
    ...
    return api.post(`/platform/payment_methods?${params.toString()}`, data);
}
