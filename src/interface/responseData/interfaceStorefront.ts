...
// Account / Address
interface AccountAddress_Attributes {
    firstname: string;
    lastname: string;
    address1: string;
...
interface AccountOrder_Attributes {
    number: string;
    item_total: string;
    ...
    display_total_minus_store_credits: number;
...
interface CartIncludedAttributes {
    name: string;
    quantity: number;
    price: string;
    slug: string;
...
interface CartIncludedrelationships {
    metafields: {
        data: Type[];
    };
    variant: {
...
interface CheckoutShipments_Include_Rate {
    id: string;
    type: string;
